...
<li>
    <a href="{{route('store.edit',$product->id)}}" class="nav-link active" data-toggle="dropdown"><i class="fe fe-edit"></i>Update</a>
            ...
            <div class="table-responsive">
              <table class="table mb-0">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control" name="advantge" value="{{$product->advantge}}">
                  </td>
                  <td>
                  ...
                  <td class="pr-0">
                    <input type="text" class="form-control" value="{{$product->target}}" name="target">
                  </td>
                </tr>
                </tbody>
              </table>
